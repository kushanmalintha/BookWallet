...
class NotificationAllListView extends StatefulWidget {
  ...
  const NotificationAllListView({Key? key, required this.globalUserId}) : super(key: key);

  @override
  State<NotificationAllListView> createState() => _NotificationAllListViewState();
}

class _NotificationAllListViewState extends State<NotificationAllListView> with AutomaticKeepAliveClientMixin {
  late NotificationController _notificationController;
  late ReviewController _reviewController;
  bool _isLoading = true;
  List<AppNotificationAll> _notifications = [];
  ...
  Future<void> _fetchNotifications() async {
    try {
      final fetchedNotifications = await _notificationController.getAllNotifications(widget.globalUserId);
      setState(() {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        ReviewModel review = await _reviewController.fetchReview(notification.reviewID);
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          title: Text(
                            notification.message, // Use the message coming from JSON directly
                            style: TextStyle(
